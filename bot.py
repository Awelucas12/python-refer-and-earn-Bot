...
BOT_TOKEN = os.environ["6435789357:AAGv0_8stJcqWt-rcJayrrwOjaWynORR2F4"]
PAYMENT_CHANNEL = "@zionsupportchat" #add payment channel here including the '@' sign
OWNER_ID = 7064581842 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@zionmainchannel"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
